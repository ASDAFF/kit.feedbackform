...
/**
 * Class kit_feedbackform
 */
class kit_feedbackform extends CModule
{
    var $MODULE_ID = "kit.feedbackform";
    var $MODULE_NAME;
    var $MODULE_DESCRIPTION;
    var $MODULE_VERSION;
    var $MODULE_VERSION_DATE;
    /**
     * kit_feedbackform constructor.
     */
    public function __construct()
    {
        ...
        if (file_exists(__DIR__ . "/version.php")) {
            ...
            $this->MODULE_NAME = Loc::getMessage("KIT_FEEDBACKFORM_NAME");
            $this->MODULE_DESCRIPTION = Loc::getMessage("KIT_FEEDBACKFORM_DESCRIPTION");
            $this->PARTNER_NAME = Loc::getMessage("KIT_FEEDBACKFORM_PARTNER_NAME");
            $this->PARTNER_URI = Loc::getMessage("KIT_FEEDBACKFORM_PARTNER_URI");
        }
    ...
    public function DoInstall()
    {
        ...
        if (CheckVersion(ModuleManager::getVersion("main"), "14.00.00")) {
            ...
            $APPLICATION->ThrowException(
                Loc::getMessage("KIT_FEEDBACKFORM_INSTALL_ERROR_VERSION")
            );
        }

        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("KIT_FEEDBACKFORM_INSTALL_TITLE") . " \"" . Loc::getMessage("KIT_FEEDBACKFORM_NAME") . "\"",
            __DIR__ . "/step.php"
        );
    ...
    public function InstallFiles()
    {
        ...
        CopyDirFiles(
            __DIR__ . "/components/kit/feedbackform",
            Application::getDocumentRoot() . "/bitrix/components/kit/feedbackform",
            true,
            true
        );
    ...
    public function InstallDB()
    {
        ...
        foreach ($arParams["LANGUAGE"] as $idLang => $arLang) {
            ...
            $arType = array(
                ...
                "NAME" => GetMessage("KIT_FEEDBACKFORM_EVENT_NAME"), // заголовок типа почтового события
                "DESCRIPTION" => GetMessage("KIT_FEEDBACKFORM_EVENT_DESCRIPTION"), //описание задающее поля типа почтового события
            );
    ...
    public function DoUninstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("KIT_FEEDBACKFORM_UNINSTALL_TITLE") . " \"" . Loc::getMessage("KIT_FEEDBACKFORM_NAME") . "\"",
            __DIR__ . "/unstep.php"
        );
    ...
    public function UnInstallDB()
    {
        ...
        $arFilter = ['=EVENT_NAME' => "KIT_FEEDBACK",];
        $arOrder = [];
