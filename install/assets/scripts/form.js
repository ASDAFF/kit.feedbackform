...
$(document).ready(function () {
    ...
    window.kit.feedbackform.closeDialog = function (context) {
        const container = $(context).parents('.kit-feedbackform__container:first');
        const dialog = container.find('.kit-feedbackform__container__dialog:first');
    ...
    window.kit.feedbackform.closeSuccessDialog = function (context) {
        const container = $(context).parents('.kit-feedbackform__container:first');
        const dialogSuccsess = container.find('.kit-feedbackform__container-succsess:first');
        const dialog = container.find('.kit-feedbackform__container__dialog:first');
