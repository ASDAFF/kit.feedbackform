...
$aTabs = array(
    array(
        "DIV" => "edit",
        "TAB" => Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_NAME"),
        "TITLE" => Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_NAME"),
        "OPTIONS" => array(
            Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_COMMON"),


            array(
                "subject",
                Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_SUBJECT"),
                "Interlabs - forms",
                array("text", 64)
            ),
            ...
            array(
                "EMAIL_FROM",
                Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_EMAIL_FROM"),
                "",
                array("text", 64)
            ),
            array(
                "EMAIL_TO",
                Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_EMAIL_TO"),
                "",
                array("text", 64)
            ),
            array(
                "EVENT_NAME",
                Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_EVENT_NAME"),
                "",
                array("text", 64)
            ),
            array(
                "MESSAGE_ID",
                Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_MESSAGE_ID"),
                "",
                array("text", 64)
            ),
...
?>
    ...
    <form action="<? echo($APPLICATION->GetCurPage()); ?>?mid=<? echo($module_id); ?>&lang=<? echo(LANG); ?>"
        ...
        <tr>
            <td width="40%" nowrap>
                <?php echo Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_AGREE_PROCESSING_FILE"); ?>
            <td width="60%">
        ...
        <input type="submit" name="apply"
               value="<? echo(Loc::GetMessage("INTERLABS_FEEDBACKFORM_OPTIONS_INPUT_APPLY")); ?>" class="adm-btn-save"/>
        <input type="submit" name="default"
               value="<? echo(Loc::GetMessage("INTERLABS_FEEDBACKFORM_OPTIONS_INPUT_DEFAULT")); ?>"/>
